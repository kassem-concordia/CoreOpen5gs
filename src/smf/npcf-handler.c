    ...
    if (SmPolicyDecision->pcc_rules) {
        ...
        OpenAPI_list_for_each(SmPolicyDecision->pcc_rules, node) {
            ...
            if(PccRule->ref_alt_qos_params){ //kassem
                ...
                // OpenAPI_alternative_qos_profile_t *AltQosProfileIter = NULL;
                ...
                //     pcc_rule->alt_qos_profile[kassem_i].gbr = ogs_sbi_bitrate_from_string(AltQosProfileIter->);
