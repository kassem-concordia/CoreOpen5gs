...
asn_TYPE_member_t asn_MBR_NGAP_GBR_QosInformation_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct NGAP_GBR_QosInformation, notificationControl), //kassem +1: was 4
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_NotificationControl,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct NGAP_GBR_QosInformation, maximumPacketLossRateDL), //kassem +1: was 3
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_PacketLossRate,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct NGAP_GBR_QosInformation, maximumPacketLossRateUL), //kassem +1: was 2
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_PacketLossRate,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct NGAP_GBR_QosInformation, iE_Extensions), //kassem +1: was 1
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolExtensionContainer_11905P96,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NGAP_GBR_QosInformation, alternativeQoSParaSetList), //kassem NEW member[8]
...
static const int asn_MAP_NGAP_GBR_QosInformation_oms_1[] = { 4, 5, 6, 7, 8 }; //kassem added 8
static const ber_tlv_tag_t asn_DEF_NGAP_GBR_QosInformation_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NGAP_GBR_QosInformation_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NGAP_GBR_QosInformation_specs_1 = {
	...
	asn_MAP_NGAP_GBR_QosInformation_oms_1,	/* Optional members */
	4, 1,	/* Root/Additions */ //kassem was 4,0
	8,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NGAP_GBR_QosInformation = {
	"GBR-QosInformation",
